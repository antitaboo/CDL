...
|
  ...
  r_Phi_all_int3 : forall (T : Gamma) (D : Delta) (V : list Var) (x : Var) (e : e_exp) (A : Evt) (phi : CDL_exp), 
          let n := NewId V in 
          let m := S n in
          (
            Seq (
...
|
  ...
  r_Pi_all_int3 : forall (T : Gamma) (D : Delta) (V : list Var) (x : Var) (e : e_exp) (A : Evt) (r : rel), 
          let n := NewId V in 
          let m := S n in
          (
            Seq (
