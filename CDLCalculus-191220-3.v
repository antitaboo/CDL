...
Notation "< p >' r" := (cdl_dia1C p r) (at level 63, p at level 60, r at level 60). (* must be less than the precedence of >', which is 61 *)
Notation "< p > e" := (cdl_dia2C p e) (at level 63, p at level 62, e at level 62).
...
Inductive tstSeq2 : Gamma -> place -> place -> Delta -> (list Var) -> Type :=
...
Inductive Seq : Gamma -> place -> place -> Delta -> (list Var) -> Type :=
  (* ****************************** rules for atomic events and formula [p]rel ************************************* *)
  
(* Rule (Phi) *)
  r_Phi_all_1 : forall (T : Gamma) (phi : CDL_exp) (D : Delta) (FV : list Var) (x : Var) (e : e_exp) (A : Evt), 
          let n := NewId FV in 
          (
...
|
  ...
  r_Phi_all_2 : forall (T : Gamma) (phi : CDL_exp) (D : Delta) (FV : list Var), 
          (
...
|
  ...
  r_Phi_dia_1 : forall (T : Gamma) (phi : CDL_exp) (D : Delta) (FV : list Var) (x : Var) (e : e_exp) (A : Evt), 
          let n := NewId FV in 
          (
            Seq ((x =' (e_2_E e) [(var n) subs-E x]) :: (T [ (var n) subs-l x ])) 
                      empty 
...
|
  ...
  r_Phi_dia_2 : forall (T : Gamma) (phi : CDL_exp) (D : Delta) (FV : list Var), 
          (
            Seq T empty (exp phi) D FV
          ) 
          -> 
...
(* Rule (Pi) *)
  r_Pi_all_1 : forall (T : Gamma) (r : rel) (D : Delta) (FV : list Var) (x : Var) (e : e_exp) (A : Evt), 
          let n := NewId FV in 
          (
            Seq ((x =' (e_2_E e) [(var n) subs-E x]) :: (T [ (var n) subs-l x ])) 
                      empty 
...
|
  r_Pi_all_2 : forall (T : Gamma) (r : rel) (D : Delta) (FV : list Var), 
          (
...
|
  r_Pi_dia_1 : forall (T : Gamma) (r : rel) (D : Delta) (FV : list Var) (x : Var) (e : e_exp) (A : Evt), 
          let n := NewId FV in 
          (
            Seq ((x =' (e_2_E e) [(var n) subs-E x]) :: (T [ (var n) subs-l x ])) 
                      empty 
...
|
  ...
  r_Pi_dia_2 : forall (T : Gamma) (r : rel) (D : Delta) (FV : list Var), 
          (
            Seq T empty (exp (hbar r)) D FV
          ) 
          -> 
